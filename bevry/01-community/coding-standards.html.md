...
The main sections and sub sections utilise a horiztonal rule. The last part of the horizontal rule should always lay on the 40th column. The headings should be concise (only a few words max)
