...
The reasoning for this is that we use to publish to the package managers component and bower, and include support for the module loaders AMD, Require.js, and global namespacing (i.e. none)—but it becomes too much to manage and deal with.
